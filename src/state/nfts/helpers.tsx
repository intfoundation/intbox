...
export const createErc721 = async (
  ...
  const url = `${API_URL}/intbox/createErc721`
  const response = await fetch(url, {
    method: 'post',
    headers: {
      'Content-Type': 'application/json',
...
// 修改NFT信息
export const updateErc721 = async (
    id: number,
    name: string,
    creatorName: string,
    description: string,
  ...
  const url = `${API_URL}/intbox/updateErc721`
  const response = await fetch(url, {
    method: 'post',
    headers: {
      'Content-Type': 'application/json'
...
export const getNftById = async (
  ...
  const url = `${API_URL}/intbox/getNftById`
  const response = await fetch(url, {
    method: 'post',
    headers: {
      'Content-Type': 'application/json'
...
export const getNftDataById = async (
  ...
  const url = `https://api.intbox.org/testnft/${token}/${tokenid}.json`
  // const response = await fetch(url,{
  //   mode: 'cors',
  //   // credentials: 'include',
  //   headers: {
...
export const getIntPriceData = async () => {
  const url = `https://api.intbox.org/intprice`
  const response = await fetch(url,{
    // mode: 'cors',
    // credentials: 'include',
    headers: {
