...
import {useGetUserNft, useNftsState, usePollNftsData} from "../../state/nfts/hooks";
import TopCardCollect from "./components/TopCardCollect";
...
const NftDetailCollect: React.FC = () => {
  ...
  const curNft = useGetUserNft(params.contract,Number(params.tokenid))
  // console.log(curNft)
  ...
  return  fetchNft?(
    <Page>
      <TopCardCollect curNft={curNft?? fetchNft}/>
...
export default NftDetailCollect
